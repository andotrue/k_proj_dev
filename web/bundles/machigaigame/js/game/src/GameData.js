...
var g_resources = [
    ...
    {src: gsDir + "button/icon_giveup.png"},
    {src: gsDir + "button/icon_hint.png"},
    {src: gsDir + "button/icon_save.png"},
    {src: gsDir + "button/save.png"},
    {src: gsDir + "button/save_off.png"},
    {src: gsDir + "label/clear.png"},
    {src: gsDir + "label/machigai.png"},
    {src: gsDir + "label/miss.png"},
    {src: gsDir + "label/otetsuki.png"},
    {src: gsDir + "label/timelimit.png"},
    {src: gsDir + "number/0.png"},
    {src: gsDir + "number/1.png"},
    {src: gsDir + "number/2.png"},
    {src: gsDir + "number/3.png"},
    {src: gsDir + "number/4.png"},
    {src: gsDir + "number/5.png"},
    {src: gsDir + "number/6.png"},
    {src: gsDir + "number/7.png"},
    {src: gsDir + "number/8.png"},
    {src: gsDir + "number/9.png"},
    ...
    {src: gsDir + "other/heart_off.png"},
    {src: gsDir + "other/heart_on.png"},
    ...
    {src: gsDir + "other/star_off.png"},
    {src: gsDir + "other/star_on.png"},
