...
use Machigai\GameBundle\Entity\ItemGroup;
use Machigai\AdminBundle\Form\ItemGroupType;
...
class ItemGroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $pager->getRepository('MachigaiGameBundle:ItemGroup', array(), array('groupCode' => 'DESC'));
     ...
     * @Method("POST")
     * @Template("MachigaiGameBundle:ItemGroup:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MachigaiGameBundle:ItemGroup:edit.html.twig")
     */
