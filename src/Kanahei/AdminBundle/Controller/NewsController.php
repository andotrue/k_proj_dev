...
use Kanahei\GameBundle\Entity\News;
use Kanahei\AdminBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $pager->getRepository('KanaheiGameBundle:News', array(), array('id' => 'DESC'));
     ...
     * @Method("POST")
     * @Template("KanaheiGameBundle:News:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KanaheiGameBundle:News')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("KanaheiGameBundle:News:edit.html.twig")
     */
