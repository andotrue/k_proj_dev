...
use Kanahei\AdminBundle\Form\RankingType;
...
class RankingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $pager->getRepository('KanaheiGameBundle:Ranking', array(), array('id' => 'DESC'));
     ...
     * @Method("POST")
     * @Template("KanaheiGameBundle:Ranking:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KanaheiGameBundle:Ranking')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("KanaheiGameBundle:Ranking:edit.html.twig")
     */
