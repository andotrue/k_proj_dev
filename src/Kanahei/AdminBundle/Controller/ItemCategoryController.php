...
use Kanahei\GameBundle\Entity\ItemCategory;
use Kanahei\AdminBundle\Form\ItemCategoryType;
...
class ItemCategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $pager->getRepository('KanaheiGameBundle:ItemCategory', array(), array('categoryCode' => 'DESC'));
     ...
     * @Method("POST")
     * @Template("KanaheiGameBundle:ItemCategory:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($categoryCode)
    {
        ...
        $entity = $em->getRepository('KanaheiGameBundle:ItemCategory')->find($categoryCode);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("KanaheiGameBundle:ItemCategory:edit.html.twig")
     */
