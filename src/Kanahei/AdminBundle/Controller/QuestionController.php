...
use Kanahei\GameBundle\Entity\Question;
use Kanahei\AdminBundle\Form\QuestionType;
...
class QuestionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $pager->getRepository('KanaheiGameBundle:Question', array(), array('id' => 'DESC'));
     ...
     * @Method("POST")
     * @Template("KanaheiGameBundle:Question:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KanaheiGameBundle:Question')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("KanaheiGameBundle:Question:edit.html.twig")
     */
