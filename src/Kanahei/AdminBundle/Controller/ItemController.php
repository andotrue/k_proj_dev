...
use Kanahei\AdminBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $pager->getRepository('KanaheiGameBundle:Item', array(), array('id' => 'DESC'));
     ...
     * @Method("POST")
     * @Template("KanaheiGameBundle:Item:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KanaheiGameBundle:Item')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("KanaheiGameBundle:Item:edit.html.twig")
     */
