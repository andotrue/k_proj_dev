...
class GameController extends BaseController
{
    ...
    {   
        ...
        return $this->render('KanaheiGameBundle:Game:index.html.twig');   
    }
...
/*        $questions = $this->getDoctrine()
                ->getEntityManager()
                ->createQuery('SELECT q from KanaheiGameBundle:Question q 
...
*/
        ...
        $level = "easy";
    	return $this->render('KanaheiGameBundle:Game:select.html.twig',array('playedQuestions'=>$playedQuestions,'user'=>$user,'questions'=>$questions, 'histories'=>$histories, 'sort'=> 'null', 'level' => $level));
    }
    public function sortQuestionsAction($sort, $level){
        ...
        switch ($sort) {
            ...
            case 'notCleared':
                if($user==null){
                    ...
                    ->createQuery('SELECT q from KanaheiGameBundle:Question q 
                                        where q.id not in (
                                            select q1.id from KanaheiGameBundle:Question q1
        ...
        return $this->render('KanaheiGameBundle:Game:select.html.twig',array('playedQuestions'=>$playedQuestions,'user'=>$user,'questions'=>$questions,'histories'=>$histories, 'sort'=>$sort, 'level' => $level));
    }
    //makelistは未使用    
    ...
    public function playAction($id)
    {
    	...
    	return $this->render('KanaheiGameBundle:Game:index.html.twig', array('csrf_token' => $token, 'uid' => $uid));	
    }
...
//        $response->prepare($request);
    ...
    {
	return $this->render('KanaheiGameBundle:Game:finish.html.twig');	
    }

    public function clearAction()
    {
	return $this->render('KanaheiGameBundle:Game:clear.html.twig');	
    }

    public function failAction()
    {
	return $this->render('KanaheiGameBundle:Game:fail.html.twig');	
    }
    public function uploadDataAction(){
        ...
        */
        ...
        if(empty($playHistory)){
            ...
            $playHistory = $em->getRepository('KanaheiGameBundle:PlayHistory')->findBy(array('userId'=>$userId));
            $playHistory->setPlayInfo($data);
            $em->flush();
        }else{
            $playHistoryId = $playHistory->getId();
            $em = $this->getDoctrine()->getManager();
            $playHistory = $em->getRepository('KanaheiGameBundle:PlayHistory')->find($playHistoryId);
            $playHistory->setPlayInfo($data);
            $em->flush();
        }
    /* 参考
    ...
    */
    ...
    public function resultUserClearAction(){
        ...
        $histories = $this->getDoctrine()
                ->getManager()
                ->getRepository('KanaheiGameBundle:PlayHistory')->findBy(array('user'=>$user,'question'=>$question[0]));
        ...
        if(empty($histories)){
            ...
            foreach ($histories as $history) {
                $em = $this->getDoctrine()->getManager();
                $previousData = $em->getRepository('KanaheiGameBundle:PlayHistory')->find($history->getId());
            ...
            $em = $this->getDoctrine()->getManager();
            $playHistory = $em->getRepository('KanaheiGameBundle:PlayHistory')->find($histories[0]->getId());
            $playHistory->setPlayInfo($playInfo);
        ...
        */
        ...
        return $this->render('KanaheiGameBundle:Game:resultUserClear.html.twig',array('clearTime'=>$clearTime,'clearPoint'=>$clearPoint,'currentPoint'=>$currentPoint));
    }
    public function resultGuestClearAction(){       
        $request = $this->get('request');
        $clearTime = $request->query->get('clearTime');

        return $this->render('KanaheiGameBundle:Game:resultGuestClear.html.twig',array('clearTime'=>$clearTime));
    }
...
*/
        ...
        return $this->render('KanaheiGameBundle:Game:resultUserFalse.html.twig',array('questionId'=>$questionId,'currentPoint'=>$currentPoint));
    }
    public function resultGuestFalseAction(){
        $request = $this->get('request');
        $questionId = $request->query->get('questionId');

        return $this->render('KanaheiGameBundle:Game:resultGuestFalse.html.twig',array('questionId'=>$questionId));
    }
    ...
    public function jankenAction()
    {
    	...
    	//return $this->render('KanaheiGameBundle:Game:select.html.twig',array('playedQuestions'=>$playedQuestions,'user'=>$user,'questions'=>$questions, 'histories'=>$histories, 'sort'=> 'null', 'level' => $level));
    	return $this->render('KanaheiGameBundle:GameJanken:index.html.twig',array());
    }
}