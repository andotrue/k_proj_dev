...
class ApplyController extends BaseController
{
    public function showAction($pageName)
    {
      ...
      return $this->render('KanaheiGameBundle:ApplyShow:' . $pageName . '.twig');
    }
...
//	        ->setFrom('support@kanahei.puzzle-m.net')
//	        ->setTo('support@kanahei.puzzle-m.net')
    ...
    function completeAction(){
      return $this->render('KanaheiGameBundle:Apply:complete.html.twig');
    }
