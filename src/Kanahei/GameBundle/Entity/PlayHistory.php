 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Kanahei\GameBundle\Entity\PlayHistoryRepository")
 */
class PlayHistory
{
    /**
     ...
     * Set question
     *
     * @param \Kanahei\GameBundle\Entity\Question $question
     * @return PlayHistory
     */
    public function setQuestion(\Kanahei\GameBundle\Entity\Question $question = null)
    {
     ...
     * Get question
     *
     * @return \Kanahei\GameBundle\Entity\Question 
     */
     ...
     * @return PlayHistory
     */
    public function addQuestion(\Kanahei\GameBundle\Entity\Question $question)
    {
        $this->question = $question;
     ...
     * @param \Kanahei\GameBundle\Entity\Question $question
     */
    public function removeQuestion(\Kanahei\GameBundle\Entity\Question $question)
    {
