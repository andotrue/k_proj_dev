...
class OAuthController extends Controller {
	...
	public function responseTokenAction() {
		...
		try {
			...
			$redirectUrl = "https://kanahei.puzzle-m.net/top/auth/oauth/response_token?method=redirect";
			//$redirectUrl = "https://kanahei.puzzle-m.net/top";
			...
			switch ($method) {
              ...
              if(!empty($applyshow)){
                $session->set("applyshow_access", null);
							...
							//認証NG	
							$response->send();
							return $this->redirect("http://pass.auone.jp/gate/?ru=https%3A%2F%2Fkanahei.puzzle-m.net%2Ftop");
						}
